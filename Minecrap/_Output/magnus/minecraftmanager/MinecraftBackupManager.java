...
public class MinecraftBackupManager extends JFrame
{
    ...
    private void initComponents() {
        ...
        this.setTitle("Minecraft Backup Manager (by magnus)");
        ...
        this.jLabel8.setText("by magnus - v1.1");
    ...
    private void uninstallActionPerformed(final ActionEvent evt) {
        final int result = JOptionPane.showConfirmDialog(this, "Are you sure that you want to uninstall Minecraft?\nCan't Undo It! (unless you have backup, hehe)", "Are you sure? (Uninstallation)", 0, 2);
    ...
    private void backupgameActionPerformed(final ActionEvent evt) {
        ...
        final File f = save.getSelectedFile();
        if (f == null) {
            return;
        }
    ...
    private void jButton1ActionPerformed(final ActionEvent evt) {
        final int world = this.getWorldSelected();
        if (world < 0) {
    ...
    private void jButton2ActionPerformed(final ActionEvent evt) {
        ...
        if (BackupUtil.getWorldNFolder(world).exists()) {
            final int result = JOptionPane.showConfirmDialog(this, "Are you sure that you want to overwrite World " + world + "?\n" + "Can't Undo It! (unless you have backup, hehe)", "Are you sure? (World Restoration)", 0, 2);
            if (result == 1 || result == -1) {
                return;
            }
        }
    ...
    private void fullgamebackupActionPerformed(final ActionEvent evt) {
